...
;(function(window, rwmpVars, undefined) {
            ...
            if( lastListenedRwmId === rwmId ){
                if( (Math.floor(playedSeconds) % rwm_duration) === 0 && !rwmpVars.adInProgress){ // pour réduire le travail
                    ...
                    if( rest === (lastLlistenedRest +1) ){
                        let data = {listen_id: listenId, listen_key: listenKey, asset_id: rwmId, seconds: Math.floor(playedSeconds), autoplay: autoplay, uuid: '1eb618ae\u002Dc6f7\u002D6172\u002Db48d\u002Df98bdb3bb4ce' };
	...
	{
	  "rwm_episode_id": 55,
	  "listen_id": 7015818313701,
      "name": "Risin' High (feat Raashan Ahmad)",
      "artist": "Ancient Astronauts",
      "album": "We Are to Answer",
		"metadata": {
			"duration": 432.9534375,
		},
         ...
         <div id="player-top-right">
            ...
            <div id="meta-container">
               <div class="song-artist-album">
                  <span data-amplitude-song-info="artist" class="song-serie cc3">10 minutes pour déstresser</span>
               </div>
...
<div id="amplitude-playlist" class="amplitude-playlist cc5">
             ...
             <div class="song-meta-data">
                <span title="Risin' High (feat Raashan Ahmad)" class="song-title">Risin' High (feat Raashan Ahmad)</span>
                <span class="song-duration cc3">07:12</span>
             </div>
             ...
             <div class="song-meta-data">
                <span title="The Gun" class="song-title">The Gun</span>
                <span class="song-duration cc3">07:12</span>
             </div>
          </div></div>
...
`;
    ...
    const rwmpContainerEl = document.querySelector(".rwm-podcast-player[data-pid='1eb618ae-c6f7-6172-b48d-f98bdb3bb4ce']");
